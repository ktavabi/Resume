  ...
  \cventry
    ...
    {2004 - 2007} % Date(s) chktex 8
    {
      \begin{cvitems} % Description(s) bullet points
        \item {Completed a doctoral dissertation exploring phonological processing during speech perception using electrophysiology sensor data at the\href{https://www.medizin.uni-muenster.de/en/biomag/institut/ehemalige-alumni.html}{\emph{Institut für Biomagnetismus und Biosignalanalyse}}.}
