...
%---------------------------------------------------------
  \cventry
    ...
    {Sep 2004 - Jun 2007} % Date(s) chktex 8
    {
      \begin{cvitems} % Description(s) bullet points
        ...
        \item {Completed dissertation after delivering two first-authored articles and graduated magna cum laude (GPA 3.4 of 4.0) as one of the first student alums from the nascent program in interdisciplinary neuroscience.}
  ...
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) bullet points
        \item {Graduated from the premed training curriculum with two-yearGraduated from the premed training curriculum with 2+ years volunteering as a student research assistant in the Department of Psychiatry \& Biobehavioral Sciences.}
