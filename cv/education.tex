...
%---------------------------------------------------------
  \cventry
    ...
    {2004 - 2007} % Date(s) chktex 8
    {
      \begin{cvitems} % Description(s) bullet points
        \item {Completed a dissertation on auditory neuroscience of phonological processing at \href{https://www.medizin.uni-muenster.de/en/biomag/institut/ehemalige-alumni.html}{IBB}.}
  ...
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) bullet points
        \item {Completed a terminal M.Sc. degree in psychology with a specialization in cognition in the \href{https://bdl.uoregon.edu}{Brain Development Lab}.}
